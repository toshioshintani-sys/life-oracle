...
export const biasInfo = {
  B1:  { name: '損失回避',         short: '失うことへの恐れが強い',               messageKey: 'loss_high',      description: '得ることより失うことを約2倍重く感じるバイアス。リスクを避けすぎたり、手放せないものを抱えすぎたりしやすい。',       magazineUrl: 'https://note.com/lifeoraclejp/m/mb942acddd918', noteUrl: 'https://note.com/lifeoraclejp/n/nfc6d75e799c3', noteScheduledAt: '2026-06-03T22:00:00Z' },
  B2:  { name: '現在バイアス',     short: '今この瞬間を優先しすぎる',             messageKey: 'present_low',    description: '将来の大きな利益より、今すぐの小さな満足を選んでしまうバイアス。先延ばしや衝動的な行動につながりやすい。',         magazineUrl: 'https://note.com/lifeoraclejp/m/md859ed8f1954', noteUrl: 'https://note.com/lifeoraclejp/n/na3974f06edb5', noteScheduledAt: '2026-06-07T22:00:00Z' },
  B3:  { name: '確証バイアス',     short: '信じたいものだけを集める',             messageKey: 'confirmation',   description: '自分の考えを支持する情報を無意識に優先するバイアス。反証を見落としやすく、判断が偏ることがある。',             magazineUrl: 'https://note.com/lifeoraclejp/m/mda7856cbb8fb', noteUrl: 'https://note.com/lifeoraclejp/n/n485f749acbca', noteScheduledAt: '2026-06-28T22:00:00Z' },
  B4:  { name: '同調バイアス',     short: '周囲の流れに乗りやすい',               messageKey: 'social',         description: '多数派の意見や行動に合わせようとするバイアス。社会的なつながりを大切にする反面、自分の判断が薄れやすい。',       magazineUrl: 'https://note.com/lifeoraclejp/m/m414c2fb6c598', noteUrl: 'https://note.com/lifeoraclejp/n/nfc531fc8b597', noteScheduledAt: '2026-06-24T22:00:00Z' },
  B5:  { name: '過信バイアス',     short: '自分を実力以上に見積もる',             messageKey: 'overconfidence', description: '自分の能力や判断を平均より高く見積もるバイアス。行動力につながる一方、リスク管理が甘くなりやすい。',           magazineUrl: 'https://note.com/lifeoraclejp/m/m96fe663f6a04', noteUrl: 'https://note.com/lifeoraclejp/n/ne1d6aa758188', noteScheduledAt: '2026-09-23T22:00:00Z' },
  B6:  { name: '現状維持バイアス', short: '変化より現状を選びやすい',             messageKey: 'status_quo',     description: '慣れ親しんだ状態を変えることへの抵抗感。安定志向の反面、必要な変化を先送りにしやすい。',                     magazineUrl: 'https://note.com/lifeoraclejp/m/ma272c44afad6', noteUrl: 'https://note.com/lifeoraclejp/n/n2de78db1732c', noteScheduledAt: '2026-07-01T22:00:00Z' },
  B7:  { name: 'アンカリング',     short: '最初の数字・情報に引っ張られる',       messageKey: 'anchoring',      description: '最初に提示された情報を基準にして判断するバイアス。価格交渉や比較判断で無意識に影響を受けやすい。',             magazineUrl: 'https://note.com/lifeoraclejp/m/m1f4abe78da35', noteUrl: 'https://note.com/lifeoraclejp/n/n791ff7bbc4ad', noteScheduledAt: '2026-06-10T22:00:00Z' },
  B8:  { name: 'サンクコスト効果', short: 'これまでの投資が惜しくて手放せない',   messageKey: 'sunk_cost',      description: 'すでに使った時間・お金・労力に引きずられて、見切る判断が遅れるバイアス。',                                   magazineUrl: 'https://note.com/lifeoraclejp/m/m5d953903008d', noteUrl: 'https://note.com/lifeoraclejp/n/n12e8884c0fe2', noteScheduledAt: '2026-05-31T22:00:00Z' },
  B9:  { name: 'フレーミング効果', short: '言い方が変わると印象が変わる',         messageKey: 'framing',        description: '同じ内容でも、表現の枠組み次第で受け取り方が大きく変わるバイアス。',                                         magazineUrl: 'https://note.com/lifeoraclejp/m/mae79a2b7792e', noteUrl: 'https://note.com/lifeoraclejp/n/nee0e6312fd01', noteScheduledAt: '2026-06-14T22:00:00Z' },
