...
// ─── プロンプト生成 ──────────────────────────────────────
function generatePersonalPrompt(mbtiType, axisScores, biasTop2, typeProfile, occupationLabel, generationLabel) {
...
export default function App() {
  ...
  function handleCopyPrompt() {
    ...
    const prompt = generatePersonalPrompt(mbtiType, scoreResult.scores, top2, typeProfile, occupationLabel, generationLabel);
        ...
        {phase === "intro" && (
          <div style={CARD_STYLE}>
            <p style={{ fontSize: 14, lineHeight: 1.8, color: TEXT_MUTED, marginBottom: 24, textAlign: "center" }}>
              ...
              あなただけの処方箋と個人専用プロンプトを生成します。<br /><br />
          ...
          <>
            ...
            <div style={CARD_STYLE}>
              ...
              {famousPeople[mbtiType] && (
                <div style={{ textAlign: "center", fontSize: 12, color: ACCENT, marginBottom: 20 }}>
            ...
            <div style={CARD_STYLE}>
              ...
              <a
                href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(`【ライフオラクル】${mbtiType}（${typeLabels[mbtiType] ?? ''}）#ライフオラクル`)}&url=${encodeURIComponent('https://meek-alfajores-ef7e71.netlify.app/')}`}
