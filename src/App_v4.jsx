...
export default function App() {
  ...
  useEffect(() => {
    ...
    fetch("/api/chat", {
      ...
      .catch(() => {
        setChatError("初回メッセージの取得に失敗しました。");
      })
  ...
  async function handleChatSend() {
    ...
    // hidden メッセージはAPI送信用に含めるが、表示フィルター済みのものを使う
          ...
          <>
            ...
            <div style={CARD_STYLE}>
              ...
              <div
                ...
                style={{ maxHeight: 480, overflowY: "auto", marginBottom: 12, display: "flex", flexDirection: "column", gap: 12 }}
              >
                {/* 初回ロード中 */}
